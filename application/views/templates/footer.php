        ...
        <script src="<?= 'http://localhost/e-voting-rt/assets' ?>/vendor/datatables/jquery.dataTables.min.js"></script>
        <script src="<?= 'http://localhost/e-voting-rt/assets' ?>/vendor/datatables/dataTables.bootstrap4.min.js"></script>
        <script>
